...
if(isset($_GET['update_order'])){
	$update_order_id = $_GET['update_order'];
...
<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li>
				<i class="fa fa-dashboard"></i> Dashboard / Update Order 
			</li>
		</ol>
	</div>
</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-houzz fa-fw"></i> Update Order				
				</h3>
			</div>
			<div class="panel-body">
				...
				<form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="form-group">
                    	<label class="col-md-3 control-label">Update Order Status</label>
                        <div class="col-md-6">
                            <select name="o_status" class="form-control" required>
...
if(isset($_POST['submit'])){
	...
	$update_customer_order = "update customer_orders set order_status='$o_status' where order_id='$update_order_id'";
	$run_customer_order = mysqli_query($con,$update_customer_order);
	$update_pending_order = "update pending_orders set order_status='$o_status' where order_id='$update_order_id'";
	$run_pending_order = mysqli_query($con,$update_pending_order);
	if($run_pending_order){
		echo "<script>alert('Product is shipped to the customer!')</script>";
